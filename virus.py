...
class ConstructSource(dj.Lookup):
    ...
    """
    contents = [['Addgene'], ['Constom made']]

@schema
class Construct(dj.Manual):
    # information of the construct
    definition = """
    construct_nickname : varchar(255)    # nickname of a construct
    ---
    construct_fullname : varchar(255)   # full anme of a construct 
    -> ConstructSource
...
class GeneticElementType(dj.Lookup):
    definition = """
    genetic_element_type : varchar(64)  # type of the gene element 
    """
    contents = [
        ['Promoter'],
...
class GeneticElement(dj.Lookup):
    ...
    definition = """
    genetic_element_nickname : varchar(32)  # nickname of the genetic element, such as GFP 
    ---
...
class Serotype(dj.Lookup):
    ...
    contents = [
        ...
        ['Unpseudotyped Rabies', 'G deleted rabies, unpseudotyped, does not transmit across synapses'],
